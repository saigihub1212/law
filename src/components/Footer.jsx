      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/about" className="text-[#C9C1B5] hover:text-white transition-colors">Our History</Link></li>
              <li><Link href="/team" className="text-[#C9C1B5] hover:text-white transition-colors">IP Lawyers</Link></li>
              <li><Link href="/blog" className="text-[#C9C1B5] hover:text-white transition-colors">Blogs</Link></li>
              <li><Link href="/gallery" className="text-[#C9C1B5] hover:text-white transition-colors">Gallery</Link></li>
              <li><Link href="/client-success" className="text-[#C9C1B5] hover:text-white transition-colors">Client Success</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/services/patent-services" className="text-[#C9C1B5] hover:text-white transition-colors">Patent Prosecution</Link></li>
              <li><Link href="/services/trademark-services" className="text-[#C9C1B5] hover:text-white transition-colors">Trademarks clearance</Link></li>
              <li><Link href="/services/copyright-services" className="text-[#C9C1B5] hover:text-white transition-colors">Software Registration</Link></li>
              <li><Link href="/services/design-registration" className="text-[#C9C1B5] hover:text-white transition-colors">Industrial Designs</Link></li>
              <li><Link href="/services/litigation-enforcement" className="text-[#C9C1B5] hover:text-white transition-colors">IP Litigation</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-[#2D2A28] mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-[#C9C1B5]/60 gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="/faqs" className="hover:text-white">Disclaimer & Cookie Policy</Link>
            <span>|</span>
