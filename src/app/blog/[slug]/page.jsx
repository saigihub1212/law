  ...
  return (
    <div className="page-enter py-24 bg-[#F8F5F0] dark:bg-[#121110] min-h-screen">
      <div className="max-w-4xl mx-auto px-6 sm:px-8 space-y-8">
        ...
        {/* Back navigation */}
        <Link href="/blog" className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-[#6D6258] hover:text-[#8B6B57] transition-colors">
          <ArrowLeft size={14} /> Back to Blogs
        </Link>
