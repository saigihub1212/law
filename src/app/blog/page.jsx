            ...
            filteredBlogs.map((b) => (
              <article key={b.slug} className="card-premium p-0 flex flex-col justify-between overflow-hidden group">
                ...
                <div className="px-8 pb-8 pt-2 mt-auto">
                  <Link href={`/blog/${b.slug}`} className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#8B6B57] hover:text-[#171717] dark:hover:text-white transition-colors">
